...
export function TaskSchedulerPage() {
  ...
  if (robots.length === 0) {
    return (
      <NoRobotsLock 
        title="Task Sequence Restricted"
        message="You must pair a physical Grabber robotic device with your profile to define, calibrate, and automate multi-step operations."
      />
    );
  }
